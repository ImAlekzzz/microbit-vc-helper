...
// UUIDs with your "imalekz" embedded
static const uint8_t STATUS_SERVICE_UUID[16] = {
    0x69, 0x6d, 0x61, 0x6c, 0x65, 0x6b, 0x7a, 0x00,
    0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0
};

static const uint8_t STATUS_CHAR_UUID[16] = {
    0x69, 0x6d, 0x61, 0x6c, 0x65, 0x6b, 0x7a, 0x01,
    0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf1
};

StatusService::StatusService() {
    service = new BLEService(STATUS_SERVICE_UUID);

    statusChar = service->addCharacteristic(
        STATUS_CHAR_UUID,
        BLECharacteristicProperties::Read | BLECharacteristicProperties::Notify
    );

    uint8_t initial = 0; // muted/off
    statusChar->setValue(&initial, 1);
}

BLEService* StatusService::getService() {
    return service;
}
